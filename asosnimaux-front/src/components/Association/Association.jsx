        ...
        <article className="association" role="presentation">
          ...
          <section className="association__values">
            ...
            <div className="association__img">
              <img src="./src/assets/imgs/patty.jpg" alt="Chiot marron du nom de Patty qui se fait caresser sous le menton" />
            </div>
          </section>
          ...
          <section className="association__mission">
            ...
            <div className="association__img">
              <img src="./src/assets/imgs/garfield-simba.jpg" alt="Un chien, Simba, et un chat, Garfield, allongés sur le dos dans l'herbe" />
            </div>
          </section>
          ...
          <section className="association__story">
            ...
            <div className="association__img">
              <img src="./src/assets/imgs/kitty.jpg" alt="Chaton du nom de kitty gris tigré qui regarde en l'air" />
            </div>
          </section>
          ...
          <section className="association__thanks">
            ...
            <div className="association__img">
              <img src="./src/assets/imgs/thankyou.jpg" alt="Un chien noir qui tient une carte 'just to say thank you' dans sa gueule" />
            </div>
          </section>
        </article>
      </div>
